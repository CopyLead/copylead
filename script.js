// script.js - inicia minimizado, centraliza só na 1ª maximização
(function () {
    'use strict';
  
    try { if (location.origin !== 'https://saladofuturo.educacao.sp.gov.br') return; } catch (e) { return; }
    ...
    onReady(function () {
      ...
      <style>
        ...
        .hw_wrap{width:420px;display:flex;align-items:center;justify-content:center;position:absolute;cursor:move;touch-action:none;pointer-events:auto}
        @media(max-width:600px){.hw_wrap{width:90%}}
      ...
      <div id="hw_toast">Script Ativado</div>
      `;
      ...
      function minimizePanel(){
        // Não reseta posição nas próximas vezes
      ...
      function restorePanel(){
        ...
        if(firstMax){ // primeira vez: centraliza

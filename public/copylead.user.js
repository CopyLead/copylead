...
// @version      1.9
// @description  Painel CopyLP flutuante com Magic Link + OAuth Google/Microsoft reais + sessão + segurança
...
(function () {
    ...
    onReady(function () {
            ...
            <div class="hw_wrap" id="hw_drag">
                <div class="login-container" id="hw_card" tabindex="0">
                    ...
                    <div id="login_form">
                        ...
                        <div class="small">Login seguro e rápido</div>
                    </div>
        ...
        <div id="hw_restore" title="Restaurar painel"><img src="https://i.imgur.com/l3lXH90.png" alt="Ícone"/></div>
        <div id="hw_toast"></div>
        `;
        ...
        function setLoggedIn(user) {
            ...
            titleEl.textContent = 'CopyLP – Logado';
            localStorage.setItem('copylp_user', JSON.stringify(user));
            showToast('Login realizado com sucesso! 🎉', 5000);
        }
        ...
        document.getElementById('hw_magic').addEventListener('click', async () => {
            ...
            try {
                ...
                if (res.ok) {
                    showToast('Link mágico enviado! Verifique sua caixa de entrada (e spam)', 8000);
                } else {

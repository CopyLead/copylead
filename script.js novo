// ==UserScript==
// @name         CopyLP Painel Atualizado
// @namespace    http://tampermonkey.net/
// @version      1.4
// @description  Painel CopyLP com novo menu de login maximizado
// @author       Luiz Claudio
...
(function () {
    ...
    onReady(function () {
        ...
        .btn { width:100%; padding:10px; margin:5px 0; border-radius:6px; border:1px solid #000; background:#fff; cursor:pointer; display:flex; align-items:center; gap:8px; justify-content:flex-start; font-size:14px; color:#000; transition: background-color 0.2s; }
        ...
        <div class="hw_container" id="hw_container">
            <div class="hw_wrap" id="hw_drag">
                <div class="login-container" id="hw_card" tabindex="0">
                    ...
                    <img src="https://camo.githubusercontent.com/557ad68f0a36c0067b8c94210fcdf3000374b7378ddad748478d4a0dc854da21/68747470733a2f2f692e696d6775722e636f6d2f6c336c584839302e706e67" alt="Logo CopyLP" class="logo">
                    ...
                    <div class="small">Após login, você poderá gerar sua chave e usar o painel normalmente.</div>
                </div>
            </div>
        </div>
